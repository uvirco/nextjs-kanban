        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="pl-6 space-y-2">
              {epic.priority && (
                <span
                  className={`px-2 py-1 text-xs font-medium rounded ${getPriorityColor(epic.priority)}`}
                >
              ...
              {epic.businessValue && (
                <span
                  className={`px-2 py-1 text-xs font-medium rounded ${getBusinessValueColor(epic.businessValue)}`}
                >
            ...
            <div className="pl-6 space-y-1">
              {epic.budgetEstimate && (
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-zinc-300">
                    {formatCurrency(epic.budgetEstimate)}
                  </span>
                </div>
              )}
              {epic.roiEstimate && (
          ...
          <div className="space-y-2">
            ...
            <div className="pl-6 space-y-2">
              {epic.riskLevel && (
                <span
                  className={`px-2 py-1 text-xs font-medium rounded ${getRiskColor(epic.riskLevel)}`}
                >
                  {epic.riskLevel} Risk
                </span>
              )}
