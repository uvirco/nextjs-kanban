...
import GoalHierarchyDiagram from "../strategy/components/GoalHierarchyDiagram";
import GoalMermaidDiagram from "../strategy/components/GoalMermaidDiagram";
...
export default function StrategyArchivePage() {
  ...
  const renderGoalCard = (goal: StrategicGoal, level: number = 0) => {
    ...
    return (
      ...
      >
        <div className="bg-zinc-900 rounded-lg border border-zinc-700 p-2 hover:border-zinc-600 transition-colors h-full">
          <div className="flex flex-col gap-0.5">
            {/* Title with expand button and status on right */}
            ...
            {/* Description only */}
            {goal.description && (
              <p className="text-xs text-zinc-400 line-clamp-1 ml-3">
                {goal.description}
              </p>
            )}
            ...
            <div className="flex gap-0.5 ml-3">
              <Button
                ...
                size="sm"
                variant="light"
                className="text-cyan-400 hover:text-cyan-300 h-5 w-5 min-w-5"
              ...
              {!goal.parent_goal_id && (
                <Button
                  ...
                  size="sm"
                  variant="light"
                  className="text-purple-400 hover:text-purple-300 h-5 w-5 min-w-5"
              ...
              <Button
                ...
                size="sm"
                variant="light"
                className="text-red-400 hover:text-red-300 h-5 w-5 min-w-5"
