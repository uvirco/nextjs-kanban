      ...
      <section className="px-3 md:px-10 py-10 pb-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
            {/* Projects Card */}
            <Link href={session ? "/projects/epics" : "/login?callbackUrl=/projects/epics"} className="group">
            ...
            {/* CRM Card */}
            <Link href={session ? "/crm" : "/login?callbackUrl=/crm"} className="group">
            ...
            <Link href={session ? "/strategy2" : "/login?callbackUrl=/strategy2"} className="group">
            ...
            <Link href={session ? "/risk-management" : "/login?callbackUrl=/risk-management"} className="group">
