...
import { IconBook, IconTarget, IconCalendar, IconUsers, IconTrendingUp, IconSettings } from "@tabler/icons-react";
    ...
    <div className="max-w-6xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-zinc-400 text-lg">
          Comprehensive guide to using this tool within the Agile/Scrum methodology.
          Learn how to plan sprints, manage epics, track progress, and collaborate effectively.
        </p>
      </div>
      ...
      <div className="mt-12 p-6 bg-zinc-800/50 rounded-lg border border-zinc-700">
        ...
        <p className="text-zinc-400 text-sm mb-4">
          Can't find what you're looking for? Check out our additional resources or contact the team.
        </p>
