...
export default function Strategy2Page() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-zinc-950 via-zinc-900 to-zinc-950 flex flex-col">
      {/* Header Bar */}
      <div className="bg-gradient-to-r from-zinc-900 to-zinc-800 border-b border-zinc-700 px-8 py-3">
      ...
      {/* Left Sidebar */}
      <div className="w-24 bg-zinc-900 border-r border-zinc-800 p-2 pt-8 flex flex-col gap-6 overflow-y-auto items-center">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          {selectedGoal && (
            <div className="space-y-8">
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded p-3 w-full">
                <div className="flex items-center gap-4 flex-wrap">
                  <div className="flex items-center gap-1.5">
                    <div className={`w-2 h-2 rounded-full bg-gradient-to-r ${getObjectiveColor(selectedGoal.id)} flex-shrink-0`}></div>
                    <h2 className="text-lg font-bold text-white">{selectedGoal.title}</h2>
                  </div>
                  ...
                  {selectedGoal.description && (
                    <p className="text-zinc-400 text-sm flex-1">{selectedGoal.description}</p>
                  )}
              ...
              {selectedGoal.children && selectedGoal.children.length > 0 && (
                <div>
                  <h3 className="text-3xl font-bold text-white mb-8">Sub-Goals</h3>
